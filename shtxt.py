...
APPROVE_LIST = ["INSUFFICIENT_FUNDS", "INCORRECT_CVC", "INCORRECT_ZIP", "3D_AUTHENTICATION", "Thank You", "THANK YOU"]
DECLINE_LIST = [
    "GENERIC_ERROR", "AUTHORIZATION_ERROR", "CARD_DECLINED", "EXPIRED_CARD",
    "CARD TOKEN IS EMPTY", "DECLINED", "PROCESSING_ERROR", "FRAUD_SUSPECTED", "INVALID_TOKEN", "tax ammount empty"
]
BLACKLIST_RESPONSES = [
